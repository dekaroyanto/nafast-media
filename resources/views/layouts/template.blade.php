                ...
                <div class="sidebar-menu">
                    <ul class="menu">
                        ...
                        @if (Auth::user()->role == 'admin')
                            ...
                            <li class="sidebar-item {{ Request::is('gaji*') ? 'active' : '' }} has-sub">
                                <a href="#" class="sidebar-link">
                                    <i class="bi bi-cash-coin"></i>
                                    <span>Gaji</span>
                                </a>

                                <ul class="submenu {{ Request::is('gaji*') ? 'active' : '' }}">
                                    <li class="submenu-item {{ Request::is('gaji') ? 'active' : '' }}">
                                        <a href="{{ route('gaji.index') }}" class="submenu-link">Daftar Gaji</a>
                                    </li>
                                    <li class="submenu-item {{ Request::is('gaji/tambah') ? 'active' : '' }}">
                                        <a href="{{ route('gaji.create') }}" class="submenu-link">Tambah Gaji</a>
                                    </li>
                                </ul>
                            </li>
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"
                                    ...
                                    <li><a class="dropdown-item" href="{{ route('profile.edit') }}"><i
                                            ...
                                            Profile</a></li>
                                    <li><a class="dropdown-item" href="{{ route('profile.editPassword') }}"><i
