        ...
        <div class="card-body">
            <form action="{{ route('gaji.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" id="jumlah_izin" name="jumlah_izin" class="form-control" value="0">
                </div>
                <div class="mb-3">
                    <label for="jumlah_sakit" class="form-label">Jumlah Sakit</label>
                    <input type="number" id="jumlah_sakit" name="jumlah_sakit" class="form-control" value="0">
                </div>
                <div class="mb-3">
                    <label for="jumlah_wfh" class="form-label">Jumlah WFH</label>
                    <input type="number" id="jumlah_wfh" name="jumlah_wfh" class="form-control" value="0">
                </div>
                <div class="mb-3">
                    <label for="jumlah_alfa" class="form-label">Jumlah Alfa</label>
                    <input type="number" id="jumlah_alfa" name="jumlah_alfa" class="form-control" value="0">
                </div>
                <div class="mb-3">
