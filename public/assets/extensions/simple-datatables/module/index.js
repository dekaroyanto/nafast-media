...
class r {
    ...
    sort(t, e, s) {
        ...
        const n =
            i.options.filters && i.options.filters[i.headings[t].textContent];
                ...
                (r = ((t, s, i, a, n) => {
                    ...
                    return (
                        d.forEach((s) => {
                            ...
                            if (r) {
                                const s =
                                    r.children[0].getAttribute("data-page");
                                if (i - s == 2) c.push(t[s]);
                                else if (i - s != 1) {
                                    const t = e("li", {
                                        class: "ellipsis",
                ...
                this.options.columns.forEach((t) => {
                    Array.isArray(t.select) || (t.select = [t.select]),
                        t.hasOwnProperty("render") &&
                            ...
                            ((this.selectedColumns =
                                this.selectedColumns.concat(t.select)),
